import { Smartphone, Monitor, Download, type LucideIcon } from 'lucide-react';
...
export const projects = [
  {
    ...
    featured: true,
    lightTheme: true,
    previews: Array.from({ length: 11 }, (_, i) => `/galeria/Monika/imagen${i + 1}.png`),
    downloads: [
    ...
    details: { playTime: 'Sin límites', playTimeEn: 'Unlimited', language: 'Español', languageEn: 'Spanish', engine: "Ren'Py", downloads: '1,250' },
    themeColor: '#FF2D78',
  },
  {
    id: 'natsuki',
    ...
    rating: 4.5,
    featured: false,
    previews: Array.from({ length: 4 }, (_, i) => `/galeria/Natsuki/imagen${i + 1}.png`),
    downloads: [
    ...
    music: 'https://www.youtube.com/embed/BDsCNVj72ig?autoplay=1&mute=0&start=1&loop=1&playlist=BDsCNVj72ig&enablejsapi=1&modestbranding=1&controls=0&showinfo=0&rel=0&iv_load_policy=3',
    details: { playTime: 'Sin límites', playTimeEn: 'Unlimited', language: 'Español', languageEn: 'Spanish', engine: "Ren'Py", downloads: '980' },
    themeColor: '#FF6B9D',
  },
  {
    id: 'yuri',
    ...
    rating: 4.6,
    featured: false,
    previews: Array.from({ length: 6 }, (_, i) => `/galeria/Yuri/imagen${i + 1}.png`),
    downloads: [
    ...
    details: { playTime: 'Sin límites', playTimeEn: 'Unlimited', language: 'Español', languageEn: 'Spanish', engine: "Ren'Py", downloads: '1,120' },
    themeColor: '#9C27B0',
  },
] as const;

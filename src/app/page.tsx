    ...
    <div className="min-h-screen bg-[#080818] text-white overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-[#080818]/60 via-transparent to-transparent" />
            ...
            <div className="flex gap-6 lg:gap-8 w-max">
              {teamMembers.map((member, i) => (
                <motion.div
                  ...
                  whileInView="visible"
                  viewport={{ once: true }}
                  className="glass-card p-8 flex flex-col items-center text-center group flex-shrink-0 w-56 sm:w-64 lg:w-72" style={{ background: 'rgba(13, 13, 36, 0.4)' }}
                >
                  <div
                  ...
                  >
                    ...
                    <div className="absolute inset-0 opacity-10 group-hover:opacity-20 transition-opacity" style={{ background: member.color }} />
                  </div>

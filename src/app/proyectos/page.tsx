        ...
        <main className="relative z-10 w-full max-w-5xl mx-auto px-4 sm:px-6 py-8 space-y-8">
          ...
          <div className="space-y-4">
            <motion.div initial={{ opacity: 0, y: -12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              ...
              <p className="text-gray-500 text-[20px] font-medium mt-1 flex items-center gap-1.5">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="p-3 rounded-xl bg-white border-2 border-[#FFB6C1] shadow-sm">
                <span className="text-[17px] font-bold uppercase block mb-0.5 text-gray-400">{t('projects.status')}</span>
                <span className="text-gray-700 font-bold text-[21px]">{status}</span>
              </div>
              <div className="p-3 rounded-xl bg-white border-2 border-[#FFB6C1] shadow-sm">
                <span className="text-[17px] font-bold uppercase block mb-0.5 text-gray-400">{t('projects.rating')}</span>
                <span className="text-gray-700 font-bold text-[21px] flex items-center gap-1">

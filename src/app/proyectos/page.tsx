  ...
  return (
    <>
      ...
      <div
        ...
        style={{ fontFamily: "'m1_fixed', monospace", backgroundColor: '#ffffff', fontSize: '16px' }}
      >
        ...
        <main className="relative z-10 w-full max-w-5xl mx-auto px-4 sm:px-6 py-8 space-y-8">
          ...
          <div className="space-y-4">
            <motion.div initial={{ opacity: 0, y: -12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              ...
              <p className="text-gray-500 text-lg font-medium mt-1 flex items-center gap-1.5">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-[#FFF0F5] rounded-2xl border-2 border-[#FFB6C1] p-5 flex flex-col items-center text-center gap-3 shadow-sm hover:shadow-md transition-shadow">
                ...
                <button className="flex items-center gap-1.5 px-4 py-1.5 rounded-full border-2 border-[#C06080] text-[#C06080] bg-white text-base font-bold hover:bg-[#C06080] hover:text-white transition-colors">
              ...
              <div className="bg-[#FFF0F5] rounded-2xl border-2 border-[#FFB6C1] p-5 flex flex-col items-center text-center gap-3 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="flex flex-col gap-2 w-full">
                  <button className="flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-full border-2 border-[#C06080] text-[#C06080] bg-white text-base font-bold hover:bg-[#C06080] hover:text-white transition-colors">

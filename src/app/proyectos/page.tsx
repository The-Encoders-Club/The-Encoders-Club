  ...
  return (
    <>
      <style>{`
        ...
        .monika-title {
          font-family: 'm1_fixed', 'RifficFree', monospace;
          color: #fffdfd;
          -webkit-text-stroke: 2.6px #ba609e;
          paint-order: stroke fill;
          letter-spacing: 0.04em;
          line-height: 1.08;
          text-shadow: 0 2px 0 rgba(186, 96, 158, 0.18);
        }
        .pink-stroke-lg {
          font-family: 'm1_fixed', 'RifficFree', monospace;
          color: #fffdfd;
          ...
          line-height: 1.12;
          text-shadow: 0 1px 0 rgba(186, 96, 158, 0.14);
        }
        .pink-stroke-sm {
          font-family: 'm1_fixed', 'RifficFree', monospace;
          color: #fffdfd;
      ...
      >
        ...
        >
          <button onClick={onClose} className="flex items-center gap-2 text-[#d6336c] hover:text-[#FF2D78] transition-colors group">
            ...
            <span className="font-bold tracking-wider uppercase text-sm sm:text-base">{t('projects.backToProjects')}</span>
          </button>
          <button
            onClick={toggleMute}
        ...
        <main className="relative z-10 w-full max-w-5xl mx-auto px-4 sm:px-6 py-8 space-y-8">
          ...
          <div className="space-y-4">
            <motion.div initial={{ opacity: 0, y: -12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              <h1 className="monika-title text-5xl sm:text-6xl lg:text-7xl font-black leading-tight">
                {project.name}
              </h1>
              <p className="text-gray-500 text-base sm:text-lg font-medium mt-2 flex items-center gap-1.5">
          ...
          <motion.div
            ...
            className="space-y-4"
          >
            <h3 className="pink-stroke-lg text-2xl sm:text-3xl font-black flex items-center gap-2.5">
            ...
            <p className="text-gray-700 leading-relaxed text-base sm:text-lg">{desc}</p>

            <div className="grid grid-cols-2 gap-3">
              <div className="p-3 rounded-xl bg-white border-2 border-[#FFB6C1] shadow-sm">
                <span className="text-xs sm:text-sm font-bold uppercase block mb-1 text-gray-400">{t('projects.status')}</span>
                <span className="text-gray-700 font-bold text-base sm:text-lg">{status}</span>
              </div>
              <div className="p-3 rounded-xl bg-white border-2 border-[#FFB6C1] shadow-sm">
                <span className="text-xs sm:text-sm font-bold uppercase block mb-1 text-gray-400">{t('projects.rating')}</span>
                <span className="text-gray-700 font-bold text-base sm:text-lg flex items-center gap-1.5">
                  {project.rating} <Star className="w-4 h-4 fill-current text-yellow-400" />
                </span>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-2">
              {project.tags.map(tag => (
                <span key={tag} className="text-sm sm:text-base px-3.5 py-1.5 rounded-full bg-white/80 border-2 border-[#FFB6C1] text-gray-600 font-semibold hover:border-[#FF6B9D] transition-colors">
                  {tag}
                </span>
              ))}
            </div>
          ...
          <motion.div
            ...
            className="space-y-3"
          >
            <h4 className="pink-stroke-lg text-2xl sm:text-3xl font-black flex items-center gap-2.5">
          ...
          >
            ...
            <ul className="space-y-2.5">
              {[
                ...
                return (
                  <li key={item.label} className="flex items-center gap-2.5 text-sm sm:text-base">
            ...
            <div className="border-t border-[#FFB6C1]/50 pt-4 space-y-2">
              <h4 className="pink-stroke-sm text-sm sm:text-base font-black uppercase tracking-widest mb-2">
                {isEs ? 'Opciones de Descarga' : 'Download Options'}
              </h4>
              {project.downloads.map((dl, i) => {
                const Icon = dl.icon;
                ...
                return (
                  ...
                  >
                    ...
                    />
                    <span
                      className="font-black uppercase tracking-wide text-base sm:text-lg"
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-[#FFF0F5] rounded-2xl border-2 border-[#FFB6C1] p-5 flex flex-col items-center text-center gap-3 shadow-sm hover:shadow-md transition-shadow">
                <h4 className="pink-stroke-sm text-lg sm:text-xl font-black flex items-center gap-1.5">
                ...
                <button className="flex items-center gap-1.5 px-4 py-2 rounded-full border-2 border-[#C06080] text-[#C06080] bg-white text-sm sm:text-base font-bold hover:bg-[#C06080] hover:text-white transition-colors">
              ...
              <div className="bg-[#FFF0F5] rounded-2xl border-2 border-[#FFB6C1] p-5 flex flex-col items-center text-center gap-3 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="flex flex-col gap-2 w-full">
                  <button className="flex items-center justify-center gap-1.5 px-3.5 py-2 rounded-full border-2 border-[#C06080] text-[#C06080] bg-white text-sm sm:text-base font-bold hover:bg-[#C06080] hover:text-white transition-colors">
            ...
            <div className="flex justify-center">
              <div className="w-full max-w-sm bg-[#FFF0F5] rounded-2xl border-2 border-[#FFB6C1] p-6 flex flex-col items-center text-center gap-3 shadow-sm hover:shadow-md transition-shadow">
                <h4 className="pink-stroke-sm text-xl sm:text-2xl font-black flex items-center gap-1.5">
                ...
                <button className="flex items-center gap-2 px-6 py-2.5 rounded-full border-2 border-[#C06080] text-[#C06080] bg-white font-bold text-base sm:text-lg hover:bg-[#C06080] hover:text-white transition-colors">

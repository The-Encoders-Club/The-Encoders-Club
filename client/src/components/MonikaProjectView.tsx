    ...
    <AnimatePresence>
      ...
      >
        ...
        <div className="relative z-10 min-h-screen bg-gradient-to-br from-[#0a0a1a]/95 via-[#1a0a1a]/90 to-[#0a0a1a]/95 w-full overflow-x-hidden">
          <nav className="sticky top-0 z-50 bg-[#0a0a1a]/90 border-b border-[#FF2D78]/30 px-4 sm:px-6 py-4 flex justify-between items-center w-full">
            <button 
              onClick={onClose}
          ...
          <main className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-12">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12 w-full">
              <div className="lg:col-span-2 space-y-8">
                ...
                <ProjectAudioPlayer
                  videoId="QIHUK68L9qQ"
                  title="Monika's Theme — Just Monika"
                  accentColor="#FF2D78"
                />

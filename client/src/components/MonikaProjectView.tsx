...
const MonikaProjectView: React.FC<ProjectViewProps> = ({ isOpen, onClose }) => {
  ...
  // Detener música al salir: El iframe se desmonta automáticamente con el componente
  // pero usamos useEffect para asegurar la limpieza si fuera necesario.
  useEffect(() => {
    if (isOpen) {
  ...
  return (
    <AnimatePresence>
      ...
      >
        {/* FONDO TEMÁTICO: Aula del Espacio */}
        <div 
        ...
        {/* MÚSICA: Your Reality (Piano/Lofi) - Auto-stop al desmontar */}
        <iframe 
          className="hidden"
          width="0" height="0" 
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              ...
              <div className="space-y-8">
                <div className="p-8 rounded-3xl bg-gradient-to-b from-white/10 to-transparent border border-white/10 backdrop-blur-xl sticky top-32">
                  ...
                  <button className="w-full py-4 rounded-2xl bg-gradient-to-r from-[#FF2D78] to-[#FF2D78]/80 text-white font-black uppercase tracking-tighter flex items-center justify-center gap-3 hover:shadow-[0_0_30px_rgba(255,45,120,0.4)] transition-all group">

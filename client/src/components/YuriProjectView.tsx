  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
        className="fixed inset-0 z-[100] bg-[#0a0a1a] text-white overflow-y-auto yuri-theme encoders-view-scroll" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}
      >
        ...
        <div className="relative z-10 min-h-screen bg-gradient-to-br from-[#0a0a1a]/95 via-[#1a0a2a]/90 to-[#0a0a1a]/95 w-full overflow-x-hidden">
          <nav className="sticky top-0 z-50 bg-[#0a0a1a]/90 border-b border-[#9C27B0]/30 px-4 sm:px-6 py-4 flex justify-between items-center w-full">
            <button 
              onClick={onClose}

...
const NatsukiProjectView: React.FC<ProjectViewProps> = ({ isOpen, onClose }) => {
  ...
  const previewImages = [
    "https://files.manuscdn.com/user_upload_by_module/session_file/310519663532412600/yMnTdiEAQHlpXyGB.png",
    "https://files.manuscdn.com/user_upload_by_module/session_file/310519663532412600/tGGpOsKUPxUtabuR.png",
    "https://files.manuscdn.com/user_upload_by_module/session_file/310519663532412600/OXXbKzIvFiCeTpiB.png",
    "https://files.manuscdn.com/user_upload_by_module/session_file/310519663532412600/JFkwWcaVWpytaeSs.png"
  ];

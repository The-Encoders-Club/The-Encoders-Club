...
const NatsukiProjectView: React.FC<ProjectViewProps> = ({ isOpen, onClose }) => {
  ...
  const mainImage = "https://files.manuscdn.com/user_upload_by_module/session_file/310519663518113549/lqfZTkbzoCrwSxwy.png";
  const galleryImages = [
    "https://files.manuscdn.com/user_upload_by_module/session_file/310519663518113549/lqfZTkbzoCrwSxwy.png",
                  ...
                  <div className="flex gap-8 border-b border-white/10">
                    {['info', 'galeria'].map((tab) => (
                      ...
                      >
                        ...
                        {activeTab === tab && (
                          <motion.div layoutId="activeTab" className="absolute bottom-0 left-0 right-0 h-0.5 bg-gradient-to-r from-[#FF2D78] to-[#FF9EBC]" />
                        )}
                      </button>
                    ))}
                  </div>
